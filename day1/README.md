...
3. Pythonプログラムを書いてみよう（モブプログラミング）
...
# 3. Pythonプログラムを実装してみよう
`implementme.py`の `categorize_triangle`関数を実装してください。

答え合わせ用に単体テストを用意しています。単体テストが通ったらクリアです。

## 目標
Pythonで変数や四則演算、if文が使えるようになる
